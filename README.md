...
1. Clone the repository:
   ```bash
   git clone https://github.com/RyN-Mo0/library-management-system.git
   ```
...
The book has been successfully added: Clean Code
The book has been successfully added: 1984
The book is already available!

===== All Books =====
Title: Harry Potter | Author: J.K. Rowling | ISBN: 111 | Available: true
Title: Clean Code | Author: Robert Martin | ISBN: 222 | Available: true
Title: 1984 | Author: George Orwell | ISBN: 333 | Available: true

===== Search =====
Title: Clean Code | Author: Robert Martin | ISBN: 222 | Available: true found!
Not found!

===== Borrow & Return =====
Ahmed borrowed: Harry Potter
The book is currently borrowed!Ahmed return: Harry Potter
Ahmed borrowed: Harry Potter

===== Remove =====
The book has been successfully removed: 1984
Title: Harry Potter | Author: J.K. Rowling | ISBN: 111 | Available: false
Title: Clean Code | Author: Robert Martin | ISBN: 222 | Available: true
